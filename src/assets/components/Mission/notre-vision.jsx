    ...
    <>
      <section className="relative bg-white dark:bg-black min-h-screen py-12 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          >
            <p className="text-xl md:text-2xl lg:md:text-3xl xl:md:text-3xl font-bold mb-12 text-justify">L’organisme à but non lucratif Sauvons l'Enfance en Difficulté (SEED) vise à promouvoir :</p>
