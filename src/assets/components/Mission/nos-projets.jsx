      ...
      <section className="relative bg-white dark:bg-black min-h-screen py-12 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <motion.p 
            ...
            className=" text-base sm:text-xl md:text-2xl xl:text-3xl font-bold text-gray-700 dark:text-gray-300 mb-16"
          >
            L'ONG SEED divise son projet social en trois axes majeurs pour répondre aux défis sociaux et éducatifs en République Démocratique du Congo.
          </motion.p>
        </div>
